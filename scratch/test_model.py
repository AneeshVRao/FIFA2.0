...
def test():
    ...
    start_years = [1872, 1993, 2005, 2010, 2014, 2018]
    ...
    for year in start_years:
        for cw in class_weights:
            ...
            print(f"Start Year: {year} | Class Weight: {cw} -> Train matches: {len(df_train)} | Acc: {acc:.4f} | Macro F1: {macro_f1:.4f} | AUC: {auc:.4f}")
